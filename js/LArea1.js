    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                $('#demo6').css({'background':'url(images/sanjiao1.png) no-repeat','background-position':'80%'});
                $('#color').css({'background':'url(images/sanjiao.png) no-repeat','background-position':'80%'});
                $('body').css('overflow','hidden');
                $('.gearArea').css({'backgroundColor':'rgba(0, 0, 0, 0.2)','display':'block'});
                $('#colorOpt').css('display','none');
                $('#overlay').css('display','none');
                _self.gearArea = document.querySelector(".gearArea");
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    '<div class="area_btn_box">' +
                    '<div class="area_btn larea_cancel" style="color:#dedddd">取消</div>' +
                    '<div class="area_btn larea_finish" id="ensure">确定</div>' +
                    '</div>' +
        ...
        close: function(e) {
            ...
            $('.gearArea').css('display','none');
            $('body').css('overflow','scroll');
              $('#demo6').css({'background':'url(images/sanjiao.png) no-repeat','background-position':'80%'});
            _self.gearArea=null;
        }
    }
    return MobileArea;
